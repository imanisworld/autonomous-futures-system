...
> **Current-state note:** PR #761 later classified the separate pre-registered first-sight family-persistence lane as `NO LONGER SHOWING EXCESS`. Current overall 212R classification is **UNPROVEN / WAIT**. The causal geometry findings below remain valid and are preserved as study-local evidence.
