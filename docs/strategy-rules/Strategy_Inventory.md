...
| 3-2-2 prospective First Live evidence — timing parity is resolved offline; now require natural lower-latency observation and more sample including losses. Any 1m observer must be evidence-only first and must not create a new setup population. | prospective timing/sample | passive collection / separately authorized observer |
