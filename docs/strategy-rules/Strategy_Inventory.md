...
| 4HR Re-Trigger (MNQ) | ✅ — retrigger is a level touch, no 5m close required | ✅ detector; 1m evidence lane deployed; #798 adds read-only 4H 2→2 continuation treatment tag | ⚠️ full-engine/risk parity audited; trigger-time parity corrected offline 2026-09-18, prospective natural 1m proof pending | ✅ pre-armed stop-touch: broad control 80/81 fills, +$1,414.60 at 1 tick; 4H 2→2 treatment subset 29 fills, +$1,444.58 / PF 2.032 at 1 tick; old +$2,886.60 trigger-backfill headline retired | ✅ broad pre-armed 3-tick H1 +$802.80 / H2 +$491.80; treatment 3-tick H1 +$663.28 / H2 +$739.30 | ✅ broad +$1,294.60 at 3 ticks; treatment +$1,402.58 at 3 ticks | n=81 / 80 broad pre-armed fills; treatment n=29 but top-three-month concentration about 94–96%; forward causal-1m sample still pending | historical `RISK_GATES_REMOVE_EDGE` still applies to the real-account cap/R:R; **2026-09-18 timing defect proven; #798 treatment is observation metadata only** | Hypothetical paper + guarded DEMO evidence; treatment observation only; real-account execution blocked by current risk constraints | **PROMISING BUT UNPROVEN** |
