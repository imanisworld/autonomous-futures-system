...
### 12HR Miyagi
**Evidence verdict:** **RETIRE — signal rejected**  
**Execution posture:** research/shadow only; parked under current account-risk constraints; not wired into `signal_engine.py`. This row does not re-run the 2026-09-24 study.
...
- **2026-09-24 timing/entry study (handoff-reported; not a file in this repo):** the overnight research set in the private handoff (commit `9305200bc0d83ad098d27b35dd969b2ef13d23f5`, entry ~11:20Z) classifies 12HR Miyagi timing/entry as **SIGNAL REJECTED / RETIRE**. Its report was explicitly not committed to this repository, and this inventory change does not re-run it. Headline recorded there: the decision clock was causal and the 2026-09-19 stop-lookahead fix held; the pooled result did not clear the study's own random-direction bar (p=0.212 against a gate below 0.10); 8 MNQ fills and 10 MES fills; 0 of 15 MNQ stops fit the 120-tick cap; 0 of 34 reached 2R. Same-corpus Miyagi variants were listed as do-not-revisit. Earlier PROMISING wording in this profile is the pre-2026-09-24 record.
...
2. ~~12HR Miyagi detector~~ — detector done (2026-07-26, see
   `12HR_MIYAGI_CANONICAL_EVIDENCE_2026-07-26.md`). Evidence verdict is now
   **RETIRE — signal rejected**, from the handoff-reported 2026-09-24
   timing/entry study. That study is not a file in this repo.
3. ~~60M 3-2-2 detector~~ — done, PR #340 (2026-07-26)
4. **Reconcile each detector against manual samples** — before any backtest
5. ~~Initial IOC replay for all three~~ — done 2026-09-07 (#483). **Timing follow-up:** 4HR and 3-2-2 documented touch/First-Live rules were not faithfully represented by waiting for completed 5m closes and now have causal pre-armed offline A/Bs. Miyagi's completed-hour lookahead was fixed by #776, and the 2026-09-19 causal/mechanics audit then found a separate trigger-bar replay defect: immediate stop/T1 is suppressed on the entry bar. Miyagi research replay is now corrected/regenerated. The 2026-09-19 numbers remain the last replay headline committed in this repo. The 2026-09-24 handoff-reported timing/entry study supersedes the PROMISING evidence verdict (SIGNAL REJECTED / RETIRE) and was not committed here. Current account stop/R:R blockers remain unchanged.
