...
| 4HR Re-Trigger (MNQ) | ✅ | ✅ | ✅ full-engine audit (#372) | ✅ 44/81 IOC fills, PF 2.00 (audit stage E); ❌ 1 approved / 0 filled through production gates | ✅ bracket H1 +$1,794.80 / H2 +$1,274.80; IOC H1 +$182.94 / H2 +$1,548.92 | ✅ 3-tick PF 1.94 (all candidates) | n=81 / 80 bracket-resolved / 1 production approval | `RISK_GATES_REMOVE_EDGE` — 75/81 over the 120-tick cap, 61/81 under 2.0 R:R; rejected set +$3,076 / PF 1.80 | **BROKEN FOR CURRENT SYSTEM RISK CONSTRAINTS — signal and bracket real** |
...
| 12HR Miyagi | ✅ | ✅ | ✅ causal-stop closure (#366) | ✅ MNQ 5/8 IOC fills PF 2.36 (audit); n/a in production — fails risk before fill | ❌ MNQ bracket H1 −$56.42 / H2 +$582.33 | ✅ MNQ 3-tick PF 2.31 | ❌ MNQ n=8, MES n=10 — far below any cell minimum | MNQ `RISK_GATES_REMOVE_EDGE` (t=2.67, bracket PF 2.85, 0/8 inside cap); MES `SIGNAL_NOT_DIRECTIONAL` (t=0.84) | **BROKEN FOR CURRENT SYSTEM RISK CONSTRAINTS** |
| 60M 3-2-2 First Live | ✅ | ✅ | ✅ full-engine closure (#367) | ✅ 20/34 IOC fills, PF 12.2 (audit, = #340); ❌ 0/34 through production gates | ✅ bracket H1 +$1,383.34 / H2 +$1,149.32; IOC H1 +$1,068.68 / H2 +$790.72 | ✅ 3-tick PF 11.9 | n=34 — thin; winner concentration already flagged | `RISK_GATES_REMOVE_EDGE` — 34/34 over the cap (median stop 486 ticks), 34/34 under 2.0 R:R; engine rejects at `TREND_STRENGTH_BELOW_REQUIRED` (26) first | **BROKEN FOR CURRENT SYSTEM RISK CONSTRAINTS — signal and bracket real** |
...
| **Wide-stop / low-R:R day-strategy risk policy** — 4HR MNQ, 3-2-2, Miyagi MNQ all lose their edge at `max_stop_ticks=120` + `min_rr_ratio=2.0` (rejected sets +$3,076 / +$2,533 / +$526). Decide: separate stop/sizing budget for this family, or an explicit "incompatible with this account" verdict. #372's concentration caveat (12 admitted 4HR trades, 99.8% of profit in two months at ~2.7× policy stop) and 3-2-2's $243/contract median stop (16% of account) are the constraints | 4HR / 3-2-2 / Miyagi verdicts | Operator decision |
