...
| **Miyagi trigger-timing parity audit** — only if Miyagi is reopened beyond research; do not inherit the 4HR timing fix without its own causal test. | executable timing parity | offline audit only |
