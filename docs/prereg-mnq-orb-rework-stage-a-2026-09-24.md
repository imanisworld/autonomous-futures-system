# Prereg — MNQ ORB rework Stage A: timeframe, volume, sweep/failure state (v0.2)

**Study ID:** `MNQ_ORB_REWORK_STAGE_A`  
**Version:** `orb-a-v0.2`  
**Trial ID:** `T-2026-09-24-prereg-mnq-orb-rework-stage-a-2026-09-24-01`  
**Status:** RESEARCH ONLY / RAW-SIGNAL SCREEN. NO EXECUTION AUTHORITY.

This prereg is frozen before the first scored run. It supersedes the unscored, closed draft PR #985; no result from that draft exists or is carried forward. It starts the approved rework of
