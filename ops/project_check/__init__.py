...
ops.project_check.preflight is not a fourth routine -- it is shared,
read-only ownership/origin-freshness machinery that Routine 1 (session-start
and precommit) calls into.
