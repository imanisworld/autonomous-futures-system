...
def _failed_breakdown_reclaim(
    ...
    """Observe a failed breakdown reclaim at a RANGE_BOUND/CHOPPY/TRANSITION turn.

    This is intentionally evidence-only. It records a measured reclaim candidate
    without changing executable trade permissions.
    """
