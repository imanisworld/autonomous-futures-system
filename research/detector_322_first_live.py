...
Ported verbatim (diffed against `git show fa7babd:research/detector_322_first_live.py`
on the abandoned, never-PR'd `codex/4hr-reconciliation` branch) as part of the
2026-07-26 salvage-and-independently-verify effort. See
docs/strategy-rules/60M_322_EXPANDED_EVIDENCE_2026-07-26.md for the full
provenance trail. No logic in this file was changed from the source branch.
"""
