...
class ReplayCandleLoader:
    ...
    def _parse(raw: dict) -> ReplayCandle:
        return ReplayCandle(
            ...
            daily_bar_type=raw.get("daily_bar_type"),
            daily_direction=raw.get("daily_direction"),
            four_hour_bar_type=raw.get("four_hour_bar_type"),
            four_hour_direction=raw.get("four_hour_direction"),
            one_hour_bar_type=raw.get("one_hour_bar_type"),
            one_hour_direction=raw.get("one_hour_direction"),
            ftfc_direction=raw.get("ftfc_direction"),
            ftfc_aligned=raw.get("ftfc_aligned"),
