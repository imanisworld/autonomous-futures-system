...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({**INSTRUMENT, "state": None}, QUOTE, "missing_state"),
        ({k: v for k, v in INSTRUMENT.items() if k != "state"}, QUOTE, "missing_state"),
        ({**INSTRUMENT, "tradability": None}, QUOTE, "missing_tradability"),
        ({k: v for k, v in INSTRUMENT.items() if k != "tradability"}, QUOTE, "missing_tradability"),
        (INSTRUMENT, {**QUOTE, "delta": None}, "missing_delta"),
        (INSTRUMENT, {**QUOTE, "theta": None}, "missing_theta"),
        (INSTRUMENT, {**QUOTE, "implied_volatility": None}, "missing_iv"),
        (INSTRUMENT, {**QUOTE, "bid_price": None}, "non_finite_bid"),
